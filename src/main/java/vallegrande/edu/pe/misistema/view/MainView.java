...
public class MainView extends BorderPane {
    ...
    private void crearMenu(){
        ...
        // Inicialización de nuevos botones
    ...
    public void mostrarClientes(){
        ...
        tarjetas.getChildren().addAll(
                ...
                crearTarjeta("Juan Gomez", "DNI: 45678912"),
                crearTarjeta("Comercial Beta", "RUC: 20987654321")
        );
        contenido.getChildren().addAll(
                titulo,
                tarjetas
    ...
    public void mostrarVentas(){
        ...
        HBox tarjetas = new HBox(15);
        tarjetas.getChildren().addAll(
                crearTarjeta("Venta #001", "Monto: S/ 2580"),
                crearTarjeta("Venta #002", "Monto: S/ 160"),
                crearTarjeta("Venta #003", "Monto: S/ 500")
        );
        contenido.getChildren().addAll(
                titulo,
                tarjetas
    ...
    public void mostrarReportes(){
        ...
        HBox tarjetas = new HBox(15);
        tarjetas.getChildren().addAll(
                crearTarjeta("Reporte Mensual", "Estado: Completado"),
                crearTarjeta("Stock Critico", "Estado: Pendiente"),
                crearTarjeta("Balance Anual", "Estado: En Proceso")
        );
        contenido.getChildren().addAll(
                titulo,
                tarjetas
